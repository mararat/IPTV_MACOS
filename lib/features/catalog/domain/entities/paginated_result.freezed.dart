...
mixin _$PaginatedResult<T> {
 ...
 List<T> get items; int get page; int get totalPages; int get totalItems;
...
@override
String toString() {
  return 'PaginatedResult<$T>(items: $items, page: $page, totalPages: $totalPages, totalItems: $totalItems)';
}
...
@useResult
$Res call({
 List<T> items, int page, int totalPages, int totalItems
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> items,  int page,  int totalPages,  int totalItems)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedResult() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> items,  int page,  int totalPages,  int totalItems)  $default,) {final _that = this;
switch (_that) {
case _PaginatedResult():
return $default(_that.items,_that.page,_that.totalPages,_that.totalItems);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> items,  int page,  int totalPages,  int totalItems)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedResult() when $default != null:
return $default(_that.items,_that.page,_that.totalPages,_that.totalItems);case _:
  return null;
...
class _PaginatedResult<T> implements PaginatedResult<T> {
  const _PaginatedResult({required final  List<T> items, required this.page, required this.totalPages, required this.totalItems}): _items = items;
