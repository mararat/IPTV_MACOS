...
mixin _$PaginatedResponseModel {
 ...
 List<Map<String, dynamic>> get items; int get page; int get totalPages; int get totalItems;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(items),page,totalPages,totalItems);

@override
String toString() {
  return 'PaginatedResponseModel(items: $items, page: $page, totalPages: $totalPages, totalItems: $totalItems)';
}
...
@useResult
$Res call({
 List<Map<String, dynamic>> items, int page, int totalPages, int totalItems
});
...
/// Create a copy of PaginatedResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? page = null,Object? totalPages = null,Object? totalItems = null,}) {
  return _then(_self.copyWith(
items: null == items ? _self.items : items // ignore: cast_nullable_to_non_nullable
as List<Map<String, dynamic>>,page: null == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Map<String, dynamic>> items,  int page,  int totalPages,  int totalItems)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedResponseModel() when $default != null:
return $default(_that.items,_that.page,_that.totalPages,_that.totalItems);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Map<String, dynamic>> items,  int page,  int totalPages,  int totalItems)  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponseModel():
return $default(_that.items,_that.page,_that.totalPages,_that.totalItems);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Map<String, dynamic>> items,  int page,  int totalPages,  int totalItems)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponseModel() when $default != null:
return $default(_that.items,_that.page,_that.totalPages,_that.totalItems);case _:
  return null;
...
class _PaginatedResponseModel implements PaginatedResponseModel {
  const _PaginatedResponseModel({required final  List<Map<String, dynamic>> items, required this.page, required this.totalPages, required this.totalItems}): _items = items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),page,totalPages,totalItems);
...
/// Create a copy of PaginatedResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? page = null,Object? totalPages = null,Object? totalItems = null,}) {
